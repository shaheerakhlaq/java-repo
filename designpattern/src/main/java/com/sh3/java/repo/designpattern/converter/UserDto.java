package com.sh3.java.repo.designpattern.converter;
...
public class UserDto {
	...
	public boolean equals(Object o) {
		...
		return isActive == userDto.isActive && Objects.equals(firstName, userDto.firstName)
	...
	public String toString() {
		return "UserDto{" + "firstName='" + firstName + '\'' + ", lastName='" + lastName + '\'' + ", isActive="
